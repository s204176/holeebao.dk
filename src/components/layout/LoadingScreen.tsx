  ...
  return (
    ...
    >
      ...
      <motion.img
        ...
        className="w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 object-contain mb-1"
      ...
      <motion.h1
        ...
        className="text-4xl sm:text-5xl md:text-6xl font-display font-bold text-white mb-1"
